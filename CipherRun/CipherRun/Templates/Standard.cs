...
{
	/// <summary>
	/// This Inject Method Uses the Standard Allocation / Memory Write / Exection methods (VirtualAllocExNuma/WriteProcessMemory/CreateRemoteThread)
	/// </summary>
